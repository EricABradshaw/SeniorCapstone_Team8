...
# running: 
# save as base64 string immediately after creating stego image; .png saving should be totally separate
# extracting:
# read base64 string as input rather than path to image?
